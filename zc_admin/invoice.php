    ...
    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <tr>
          ...
          <tr>
            <td><strong><?php echo ENTRY_ORDER_ID; ?></strong></td>
            <td><?php echo sprintf("%09d", $oID); ?></td>
          </tr>
          <tr>
            <td><strong><?php echo ENTRY_DATE_PURCHASED; ?></strong></td>
...
<?php } ?>
      <tr>
        <td id="customerInfo" valign="top">
            <b><?php echo ENTRY_SOLD_TO; ?></b>
            <br />
            <?php echo ucwords(zen_address_format($order->billing['format_id'], $order->billing, 1, '', ' <br> ')); ?>
        </td>
        <td id="customerInfo" valign="top">
            <b><?php echo ENTRY_SHIP_TO; ?></b>
            <br />
            <?php echo ucwords(zen_address_format($order->delivery['format_id'], $order->delivery, 1, '', ' <br> ')); ?>
        </td>
      </tr>
    </table></td>
  </tr>
...
<table style="float:left;" border="0" cellspacing="0" cellpadding="2">
      ...
      <tr>
        ...
        <td class="main"><?php echo sprintf("%09d", $oID); ?>
      </tr>
    </table>
<table border="0" cellspacing="0" cellpadding="2" style="float:right;">
      <tr>
        <td class="main"><strong>Email:</strong></td>
        <td class="main"> <?php echo '<a href="mailto:' . $order->customer['email_address'] . '">' . $order->customer['email_address'] . '</a>'; ?> </td>
      </tr>
      <tr>
        <td class="main"><b>Landline:</b></td>
        <td class="main"><?php echo $order->customer['telephone']; ?></td>
      </tr>
      <tr>
        <td class="main"><b>Mobile:</b></td>
...
<?php if (ORDER_COMMENTS_INVOICE > 0) { ?>
      <tr>
        <td class="main"><table border="0" cellspacing="0" cellpadding="5">
          <tr>
            <td><strong><?php echo TABLE_HEADING_DATE_ADDED; ?></strong></td>
            <td><strong><?php echo TABLE_HEADING_STATUS; ?></strong></td>
            <td><strong><?php echo TABLE_HEADING_COMMENTS; ?></strong></td>
          </tr>
<?php
    ...
    if ($orders_history->RecordCount() > 0) {
      ...
      while (!$orders_history->EOF) {
        $count_comments++;
        echo '          <tr>' . "\n" .
             '            <td>' . zen_datetime_short($orders_history->fields['date_added']) . '</td>' . "\n";
        echo '            <td>' . $orders_status_array[$orders_history->fields['orders_status_id']] . '</td>' . "\n";
        echo '            <td>' . ($orders_history->fields['comments'] == '' ? TEXT_NONE : nl2br(zen_db_output($orders_history->fields['comments']))) . '&nbsp;</td>' . "\n" .
             '          </tr>' . "\n";

...
define('BUTTON_IMAGE_ADD_TO_CART', 'button_add_to_cart.png');
...
define('BUTTON_IMAGE_BUY_NOW', 'button_buy_now.png');
define('BUTTON_IMAGE_CANCEL', 'button_cancel.png');
define('BUTTON_IMAGE_CHANGE_ADDRESS', 'button_change_address.png');
define('BUTTON_IMAGE_CHECKOUT', 'button_checkout.png');
define('BUTTON_IMAGE_CONFIRM_SEND', 'button_confirm_send.png');
...
define('BUTTON_IMAGE_DELETE_SMALL', 'button_delete_small.png');
define('BUTTON_IMAGE_DOWNLOAD', 'button_download.png');
define('BUTTON_IMAGE_EDIT_SMALL', 'small_edit.png');
define('BUTTON_IMAGE_IN_CART', 'button_in_cart.png');
define('BUTTON_IMAGE_LOGIN', 'button_login.png');
define('BUTTON_IMAGE_NEXT', 'button_next.png');
define('BUTTON_IMAGE_PREVIOUS', 'button_prev.png');
...
define('BUTTON_IMAGE_SEND', 'button_send.png');
define('BUTTON_IMAGE_SEND_A_GIFT_CERT', 'button_send_a_gift_cert.gif');
define('BUTTON_IMAGE_SEND_ANOTHER', 'button_send_another.png');
define('BUTTON_IMAGE_SHIPPING_ESTIMATOR', 'button_shipping_estimator.gif');
define('BUTTON_IMAGE_SOLD_OUT','button_sold_out.png');
define('BUTTON_IMAGE_SOLD_OUT_SMALL','button_sold_out_sm.png');
define('BUTTON_IMAGE_SUBMIT', 'button_submit.png');
define('BUTTON_IMAGE_UNSUBSCRIBE', 'button_unsubscribe.png');
...
define('BUTTON_IMAGE_GOTO_PROD_DETAILS', 'button_goto_prod_details.png');
define('BUTTON_IMAGE_MORE_REVIEWS', 'button_more_reviews.gif');
define('BUTTON_IMAGE_CONTINUE_CHECKOUT', 'button_continue_checkout.png');
//define('PREVNEXT_BUTTON_NEXT', '[Next&nbsp;&gt;&gt;]');
//define('PREVNEXT_BUTTON_LAST', 'LAST&gt;&gt;');


define('BUTTON_IMAGE_CREATE_ACCOUNT', 'button_create_account.png');
